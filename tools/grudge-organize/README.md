...
3. **Reports** — writes `repos.csv`, `duplicates.csv`, and a full `report.json`
   you can review before changing anything.
...
3. Re-run with `--apply`.
4. Verify `F:\github` looks right and your assets are intact.
5. Delete the `quarantine/` folder to reclaim the space.
